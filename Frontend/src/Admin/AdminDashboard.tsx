      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6 border-l-4 border-yellow-500">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-gray-500 text-sm">Approved Vendors</p>
              <p className="text-2xl font-semibold text-gray-800">487</p>
            </div>
          </div>
        </div>
          ...
          {[1, 2, 3, 4, 5].map((item) => (
            <div key={item} className="border-b border-gray-100 pb-4">
              <div className="flex justify-between">
                <div className="flex items-center">
                  <div className="h-10 w-10 rounded-full bg-yellow-100 flex items-center justify-center text-yellow-500 mr-3">
                    <svg
                      className="w-5 h-5"
                      fill="none"
                      stroke="currentColor"
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">User ID: #1234{item}</p>
                  </div>
                </div>
