...
import { useVendorRequestForgetPassword } from "@/hooks/vendorCustomHooks"
...
const ForgotPasswordVendor: React.FC = () => {
  ...
  const { mutate: requestOtp, isPending: isLoading } = useVendorRequestForgetPassword()
